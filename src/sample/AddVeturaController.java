...
import sample.RentACarController;
import java.net.URL;
...
public class AddVeturaController implements Initializable {
    ...
    public void addVetura() throws SQLException{
        String sql = "INSERT INTO vehicle(name, model, plates, color, km, availability) "
                + "VALUES('" + txtVetura.getText() + "','" + txtModeli.getText() + "','" + txtKm.getText() + "','" + txtTargat.getText() + "','"
                + txtNgjyra.getText() + "',1);";
