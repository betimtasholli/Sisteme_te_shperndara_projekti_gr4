...
import static chat.ChatConstants.GET_COMMENT;
import static chat.ChatConstants.GET_COMMENT_COUNT;
import static chat.ChatConstants.SEND_COMMENT;
import static chat.ChatConstants.SEND_HANDLE;
        ...
        while (true) {
          ...
          switch(request) {
              case SEND_HANDLE: {
                  ...
                  textArea.appendText(handle+" is connected"+'\n');
                  break;
              }
              case SEND_COMMENT: {
